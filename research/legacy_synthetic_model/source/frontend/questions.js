...
// 13 questions: 5 reasoning + 6 behavioral scenarios + 1 honesty trap + 1 open-text
...
export const QUESTIONS = [
  {
    ...
    section: "A",
    type: "number",
    question: "You borrow Rs. 6,000 at simple interest of 2.5% per month. How much do you owe after 4 months?",
    hint: "Use simple interest (do not compound), then round to the nearest Rs. 10.",
    prefix: "Rs.",
    min: 0,
    max: 10000,
    integer: true,
  ...
  // ---------------------------------------------------------------------------
  // SECTION B — Behavioral Decision Scenarios (6 scenarios + one honesty item)
  ...
  // The response remains submit-able at any length. The backend applies only
  // a transparent, bounded format-quality adjustment; it uses no NLP semantics.
  // ---------------------------------------------------------------------------
