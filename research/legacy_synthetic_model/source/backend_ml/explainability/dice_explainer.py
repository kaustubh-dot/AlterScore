...
DEFAULT_COUNTERFACTUAL_POLICIES: Final[dict[str, dict[str, Any]]] = {
    ...
    "locus_of_control": {
        "direction": "increase",
        "target": 0.8,
        "plain_language": "Showing more proactive problem solving could lift the score.",
    },
    "resilience_score": {
        "direction": "increase",
        "target": 0.8,
        "plain_language": "Showing resilient planning after setbacks could lift the score.",
    },
}
