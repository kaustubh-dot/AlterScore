...
PRESETS = {
    "thoughtful": {
        ...
        "answers": {
            ...
            "CRT_q1": 5, "CRT_q2": 47,
            "scenario_s1": "s1_a", "scenario_s2": "s2_b", "scenario_s3": "s3_c",
            "scenario_s4": "s4_a", "scenario_s5": "s5_b", "scenario_s6": "s6_a",
        ...
        "behavioral": {
            "avg_response_time_ms": 5300.0, "answer_change_rate": 0.018, "session_duration_sec": 210.0,
            "dropout_count": 0, "scroll_hesitation_score": 0.037, "risk_response_speed_ratio": 0.98,
            "time_of_day": "morning", "device_type": "desktop", "typing_speed_wpm": 56.0
        }
    },
    "impulsive": {
        "id": "impulsive",
        "answers": {
            ...
            "scenario_s1": "s1_d", "scenario_s2": "s2_d", "scenario_s3": "s3_d",
            "scenario_s4": "s4_d", "scenario_s5": "s5_a", "scenario_s6": "s6_d",
            "honesty_trap_q1": 3, "scenario_s8": "s8_d",
            "open_response_text": "I had a crisis and solved it. Standard situation."
        },
        "behavioral": {
            "avg_response_time_ms": 550.0, "answer_change_rate": 0.0, "session_duration_sec": 22.0,
            "dropout_count": 0, "scroll_hesitation_score": 0.0, "risk_response_speed_ratio": 1.0,
            "time_of_day": "morning", "device_type": "mobile", "typing_speed_wpm": 15.0
        }
    },
    "manipulated": {
        "id": "manipulated",
        "answers": {
            "numeracy_q1": 6600, "numeracy_q2": 1120, "financial_literacy_q1": 1,
            "CRT_q1": 5, "CRT_q2": 47,
            "scenario_s1": "s1_a", "scenario_s2": "s2_a", "scenario_s3": "s3_a",
            "scenario_s4": "s4_a", "scenario_s5": "s5_a", "scenario_s6": "s6_a",
        ...
        "behavioral": {
            "avg_response_time_ms": 1800.0, "answer_change_rate": 0.0, "session_duration_sec": 75.0,
            "dropout_count": 0, "scroll_hesitation_score": 0.0, "risk_response_speed_ratio": 1.0,
            "time_of_day": "night", "device_type": "desktop", "typing_speed_wpm": 92.0
        }
    },
    "average": {
        "id": "average",
        "answers": {
            "numeracy_q1": 6600, "numeracy_q2": 1120, "financial_literacy_q1": 1,
            "CRT_q1": 5, "CRT_q2": 24,
            "scenario_s1": "s1_c", "scenario_s2": "s2_c", "scenario_s3": "s3_b",
            "scenario_s4": "s4_b", "scenario_s5": "s5_c", "scenario_s6": "s6_b",
            "honesty_trap_q1": 3, "scenario_s8": "s8_c",
            "open_response_text": "I had a sudden emergency when my laptop broke and I needed it for client projects."
        },
        "behavioral": {
            "avg_response_time_ms": 3200.0, "answer_change_rate": 0.111, "session_duration_sec": 220.0,
            "dropout_count": 1, "scroll_hesitation_score": 0.148, "risk_response_speed_ratio": 1.05,
            "time_of_day": "morning", "device_type": "tablet", "typing_speed_wpm": 42.0
        }
    }
}
...
def test_thoughtful_applicant_scores_well(runtime_artifacts):
    ...
    assert res.repayment_probability > 0.3, "Thoughtful applicant should have solid probability."

def test_impulsive_applicant_is_penalized(runtime_artifacts):
    req = _build_request(PRESETS["impulsive"])
    res = score_request_with_bundle(req, runtime_artifacts)
    assert res.credit_score <= 350, "Impulsive applicant should hit the credit score floor."
    assert res.repayment_probability < 0.1, "Impulsive applicant should be heavily penalized by governance."
...
def test_manipulated_applicant_triggers_consistency_penalty(runtime_artifacts):
    ...
    assert res.credit_score < res_thoughtful.credit_score, "Manipulated applicant must score lower than thoughtful."
    assert res.repayment_probability < res_thoughtful.repayment_probability, "Governance penalty must reduce probability."
...
def test_average_applicant_falls_in_middle_tier(runtime_artifacts):
    ...
    assert res.repayment_probability > res_impulsive.repayment_probability, "Average should beat impulsive."
    assert res.repayment_probability < res_thoughtful.repayment_probability, "Average should score lower than thoughtful."
