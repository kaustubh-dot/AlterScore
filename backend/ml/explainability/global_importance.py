...
FEATURE_DISPLAY_NAMES: Final[dict[str, str]] = {
    ...
    "future_orientation": "Long-Term Financial Planning",
    "delay_discounting_rate": "Delay Discounting Rate",
    "risk_attitude": "Risk Attitude",
    "risk_consistency_flag": "Risk Consistency Flag",
    "loss_aversion_score": "Financial Risk Tolerance",
    "locus_of_control": "Proactive Problem Solving",
    "conscientiousness_score": "Financial Consistency and Follow-Through",
    "social_capital_score": "Network Support Reliance",
    "honesty_score": "Honesty Score",
    "resilience_score": "Business Resilience",
