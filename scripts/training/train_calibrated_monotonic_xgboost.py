...
def train_calibrated_monotonic_xgboost(
    *,
    ...
    validate_synthetic_dataset(aligned_dataset, expected_row_count=row_count)

    text_pca_path = MODEL_PREPROCESSORS_DIR / "text_pca.pkl"
    ...
    artifact_spec = {
        ...
        "text_pca": (text_pca_path, "models/preprocessors/text_pca.pkl"),
